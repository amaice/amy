...
public class AmySpawnerTileIV extends BlockEntity {
    public AmySpawnerTileIV(BlockPos pos, BlockState state) {
        super(TileEntityInit.AMY_SPAWNER_IV.get(), pos, state);
    }
    int timer = 0;
    int seconds = 10;

    public static <T extends BlockEntity> void tick(Level level, BlockPos pos, BlockState state, T be) {
        AmySpawnerTileIV tile = (AmySpawnerTileIV) be;

...
public class AmySpawnerTileIII extends BlockEntity {
    public AmySpawnerTileIII(BlockPos pos, BlockState state) {
        super(TileEntityInit.AMY_SPAWNER_III.get(), pos, state);
    }
    int timer = 0;
    int seconds = 10;

    public static <T extends BlockEntity> void tick(Level level, BlockPos pos, BlockState state, T be) {
        AmySpawnerTileIII tile = (AmySpawnerTileIII) be;
